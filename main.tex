...
% \SetColorProfile{9A3136}{9D6669}{999731}{317499}{A1B8C5}
...
\addbibresource{/home/never/Documents/Bibliography/allkindsofstuff.bib}
...
\begin{document}
	...
	\author{Ricky Licky}
	\collaboration{Joe Bite'em}
	\affiliation{
	Carl-Friedrich-Gauß Gymnasium Hockenheim\\
	\href{https://github.com/minced1}{GitHub}\\
	}
	\abstract{This is a very cool abstract. Additional package are listed right under the required packages in \texttt{NotesTeX.sty}.
	...
	\emailAdd{email@provider.com}
	\keywords{dska kdlsöa dkwöla dsads}
	\dedicated{Dedicated to your Momma}
	\acknowledgments{SomeAcknowledgements}
...
\begin{margintable}\vspace{.8in}\footnotesize
		...
		\end{tabularx}
	\end{margintable}
	For \textit{NotesTeX,} \oldstylenums{1946} the following \oldstylenums{0123456789} packages are required
	\begin{center}
